...
\033[1;91m☞ Auther     :ANIK SARKER 

\033[1;92m☞ WhatsApp   : 01956330384

\033[1;95m☞ YouTube    : https://www.youtube.com/@aniksarker55921
...
def menu():
	...
	print (S + '[☆] ' + G + 'ANIK: ' + R + a['name'])

	print (S + '[☆] ' + G + 'Anik vai: ' + R + a['id'])
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 01956330384✓')

	    psb('WellCome To ANIK67')

	    psb('Congratulations ANIK67 Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ 786786✓')

	    psb('🔓Password ☆ 786786✓')

	    psb('Subscrib My Youtube Channel https://www.youtube.com/@aniksarker55921✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/ANIK67 && python2 B4.py')
